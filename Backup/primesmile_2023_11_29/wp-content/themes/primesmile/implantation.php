...
<section class="page__header service inc">
	<div class="container">
		<div class="row">
					...
					<div class="col-lg-5">
						<div class="stage__item <?php
							...
							<?php endif; ?> ">
								<div <?php
										if (get_field("stages_prompt2")) :
										?> class="numb" <?php else : ?> class="numbs" <?php endif; ?>>1</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 text-center">
					...
					<?php the_field('text_system_implants'); ?>
				</div>
			</div>
			<div class="row justify-content-center">
			...
			<div class="row">
				...
				<div class="col-12 text-center">
					<?php the_field('text_after_system_implant'); ?>
				</div>
			</div>
		</div>
	</section>
...
<section class="servicess__title inc">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<?php the_field('block_before_steps'); ?>
			</div>
		</div>
	</div>
</section>
...
<section class="servicess__title inc">
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2><?= CFS()->get('block_name_stage'); ?></h2>
				<p class="tc"><?= CFS()->get('block_text_stage'); ?></p>
			</div>
		</div>
	</div>
</section>
...
<section class="stage">
	<div class="container">
		<div class="row justify-content-center">
			<div class="col-lg-5">
				<div class="stage__item mb__0">
					<div class="stage__item-header">
						<div class="numbs">1</div>
						<h3 class="h3"><?= CFS()->get('name_stage'); ?></h3>
						<div class="stage__sub_title"><?= CFS()->get('text_small_stage'); ?>
							<i> 	
								<div class="stages_prompt">
								</div>
							</i>
					...
					<ul>
						<?php
						$block_stage = CFS()->get('block_stage');
						foreach ($block_stage as $item) {
						?>
							<li>
								<img src="<?=$item['icon_stage']; ?>" alt="<?=$item['icon_stage']; ?>">
								<span><?=$item['name_stage']; ?></span>
							</li>
						<?
						}
						?>
