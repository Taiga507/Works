(function( $ ) {
  ...
  $('.togle-boshka').click(function(){
      // $(this).find('.review__all_text').toggleClass('active');
      $(this).find('.review__text').toggleClass('active');
  });
  $('.togle-diabosha').click(function(){
      // $(this).find('.review__all_re').toggleClass('active');
      $(this).find('.review__re').toggleClass('active');
  });
  ...
  // tabs
  $('div.faq__issues-tabs').on('click', 'div:not(faq__issues-tab_active)', function() {
    $(this)
      .addClass('faq__issues-tab_active').siblings().removeClass('faq__issues-tab_active')
      .closest('div.container').find('div.faq__content').removeClass('faq__content_active').eq($(this).index()).addClass('faq__content_active');
  });
