							...
							<div class="accordion" id="accordionExample">
								...
								while( have_rows('education') ): the_row(); ?>
									...
									<div class="card">
										...
										<div id="collapse<?php echo $a; ?>" class="collapse" aria-labelledby="heading<?php echo $a; ?>" data-parent="#accordionExample">
											<div class="card-body">
												<?php echo $deck; ?>
											</div>
										</div>
		            ...
		            <?php while( have_rows('service') ): the_row(); ?>
		                ...
		                ?>
		                    <div class="service__item" href="<?php echo $link ?>">
		                        ...
		                        <div class="service__deck"><?php echo $deck ?></div>
				...
				<div class="review__slider">
					...
					<div class="review__item">
						<div class="review__text">
							<div class="review__name review_name_aaboba">
