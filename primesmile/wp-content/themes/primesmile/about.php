	...
	<?/* <div class="col-lg-8 offset-lg-2 text-center"> */?>
			...
			<?/* <h2 class="h2 aboba-left"> */?>
				...
				<div class="aboutrating__icons">
					<a class="aboutrating__item" href="https://yandex.ru/maps/org/stomatologicheskiy_tsentr_prime_smile/1577849667/reviews/?ll=37.584125%2C55.800982&source=wizbiz_new_text_single&z=18"><img src="<?php echo get_template_directory_uri(); ?>/images/yandeks.png" alt="yandex"></a>
					<a class="aboutrating__item" href="https://2gis.ru/moscow/firm/70000001020632793"><img src="<?php echo get_template_directory_uri(); ?>/images/2gis.png" alt="2gis"></a>
					<a class="aboutrating__item" href="https://prodoctorov.ru/moskva/lpu/43486-praym-smayl/#otzivi"><img src="<?php echo get_template_directory_uri(); ?>/images/prodoktorov.png" alt="prodoktorov"></a>
					<a class="aboutrating__item" href="https://docdoc.ru/clinic/praym_smayl#reviews"><img src="<?php echo get_template_directory_uri(); ?>/images/sber.png" alt="sber"></a>
					<a class="aboutrating__item" href="https://www.kleos.ru/meditsina/stomatologicheskiij-tsentr-prime-smile/"><img src="<?php echo get_template_directory_uri(); ?>/images/kleos.png" alt="kleos"></a>
					<a class="aboutrating__item" href="https://zoon.ru/msk/medical/stomatologicheskij_tsentr_prime_smile_na_metro_dmitrovskaya/"><img src="<?php echo get_template_directory_uri(); ?>/images/zun.png" alt="zoon"></a>
					<a class="aboutrating__item" href="https://yellmed.ru/stomatologii/praym-smayl"><img src="<?php echo get_template_directory_uri(); ?>/images/el.png" alt="yell"></a>
					<a class="aboutrating__item" href="https://doctu.ru/msk/clinic/stomatologija-prajjm-smajjl/services"><img src="<?php echo get_template_directory_uri(); ?>/images/doktu.png" alt="doktu"></a>
					<a class="aboutrating__item" href="https://like.doctor/moskva/kliniki/stomatologicheskiy-tsentr-praym-smayl"><img src="<?php echo get_template_directory_uri(); ?>/images/lajk.png" alt="lajk"></a>
				</div>
