...
<section class="specialists specialists__page">
	<div class="container">
        <div class="doctors-text">
            ...
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet a, venenatis vitae, justo nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. Donec pede justo, fringilla vel, aliquet nec, vulputate eget, arcu. In enim justo, rhoncus ut, imperdiet.</p>
        </div>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <a href="<?php echo $link ?>" class="specialists__item text-center">
                        ...
                        <div class="specialists__item-text">
                            <div class="specialists__item-name familia-magazin"><?php echo $name ?></div>
                        	<div class="specialists__item-surname ima-magazin"><?php echo $surname ?></div>
