...
if( function_exists('acf_add_options_page') ) {
    $option_page = acf_add_options_page(array(
        'page_title'         => 'Мы заботимся',
        'menu_title'         => 'Мы заботимся',
        'menu_slug'          => 'care',
    ...
    $option_page = acf_add_options_page(array(
        'page_title'         => 'Наши технологии',
        'menu_title'         => 'Наши технологии',
        'menu_slug'          => 'technologies',
        'capability'         => 'edit_posts',
        'redirect'           => false
    ));
    $option_page = acf_add_options_page(array(
        'page_title'         => 'Примеры работ',
        'menu_title'         => 'Примеры работ',
        'menu_slug'          => 'examples',
        'capability'         => 'edit_posts',
        'redirect'           => false
    ));
    ...
    $option_page = acf_add_options_page(array(
        'page_title'         => 'Опции форм',
        'menu_title'         => 'Опции форм',
        'menu_slug'          => 'myform',
        'capability'         => 'edit_posts',
        'redirect'           => false
    ));
