...
$("#buninskayablock").hide();

$('#buninskaya').click(function () {
    $('#buninskayablock').show();
    $('#scherbinkablock').hide();
    $('#scherbinka').addClass('btn-metro-scherbinka-non-active').removeClass('btn-metro-scherbinka');
});

$('#scherbinka').click(function () {
    $('#scherbinkablock').show();
    $('#buninskayablock').hide();
});

$("#buninskaya-block-mob").hide();

$('#buninskaya-mob').click(function () {
    $('#buninskaya-block-mob').show();
    $('#scherbinka-block-mob').hide();
});

$('#scherbinka-mob').click(function () {
    $('#scherbinka-block-mob').show();
    $('#buninskaya-block-mob').hide();
});
...
$("#family-magic").hover(function () {
    $('#family-round-first').toggleClass('magic-for-family');
});

$("#children-magic").hover(function () {
    $('#children-round-first').toggleClass('magic-for-children');
});

$("#grand-magic").hover(function () {
    $('#grand-round-first').toggleClass('magic-for-grand');
});
...
const bannerSlider = new ItcSimpleSlider('#banner-slider', {
    loop: true,
    autoplay: false,
    interval: 2000,
    swipe: true
...
//     const slider = new ItcSimpleSlider('#price', {
//         autoplay: false,
//         loop: true,
//         swipe: true
//     });
...
document.addEventListener('DOMContentLoaded', () => {
    // инициализация слайдера
    const slider = new ItcSimpleSlider('#doc-slider', {
        autoplay: false,
        loop: true,
        swipe: true
    });
...
document.addEventListener('DOMContentLoaded', () => {
    // инициализация слайдера
    const slider = new ItcSimpleSlider('#gallary', {
        autoplay: false,
        loop: true,
        swipe: true
    });
    // назначим обработчик при нажатии на кнопку .btn-prev
    document.querySelector('.gallary-btn__prev').onclick = () => {
        // перейдём к предыдущему слайду
        slider.prev();
    }
    // назначим обработчик при нажатии на кнопку .btn-next
    document.querySelector('.gallary-btn__next').onclick = () => {
        // перейдём к следующему слайду
        slider.next();
    }
});
...
document.addEventListener('DOMContentLoaded', () => {
    // инициализация слайдера
    const slider = new ItcSimpleSlider('#reviews', {
        autoplay: false,
        loop: true,
        swipe: true
    });
...
const observe = (classElem) => {
    let options = { threshold: [0.5] };
    let observer = new IntersectionObserver(onEntry, options);
    let elements = document.querySelectorAll(classElem);
    for (let elm of elements) {
        observer.observe(elm);
    }
}

observe('.video__first-description');
observe('.video__sec-description');
observe('.safety__descr');
observe('.adapt__descr');
observe('.present__descr');
observe('.frendly-atm__descr');
observe('.game-zone__descr');
observe('.news__cloud');

$(document).ready(function () {
    $(".owl-carousel__price").owlCarousel({
        loop: false,
        nav: false,
        center: false,
        dots: false,
